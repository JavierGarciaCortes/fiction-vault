...
- `Referencias/Trama principal.md` — conflicto central
...
- `.fiction/character_states.json` — estados por capítulo
- `.fiction/voice_profiles.json` — perfiles de voz
- `Mundo/Personajes/*.md` — fichas completas
