...
- `Referencias/Trama principal.md` — premisa, conflicto central
- `Referencias/Léxico.md` — términos del mundo
- `Referencias/Outliner.md` — estructura, arco
...
1. `get_character(Kaylen)` — entender su arco y motivación
...
| **Conflicto** | De `Trama principal.md`: ¿qué quiere el protagonista y qué se lo impide? |
...
- Kaylen: quién es, qué descubre, qué decide
- Las stakes: si roba la Piedra, el Velo cae y los corruptos entran
